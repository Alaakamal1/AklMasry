      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {CategoryModel.map((cat) => (
          <Link
            ...
            className="p-6 bg-[#4c3f2d] rounded-2xl shadow hover:shadow-lg text-center"
          >
            <h2 className="text-xl font-semibold mb-2 text-gray-100">{cat.categoryName}</h2>
          </Link>
        ))}
      </div>
    </main>
